    ...
    <footer className="border-t border-gray-200 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          {/* Customer Service */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900">{t("customerService")}</h3>
            <ul className="mt-4 space-y-2">
              <li>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900">{t("privacy")}</h3>
            <ul className="mt-4 space-y-2">
              <li>
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900">{t("newsletter")}</h3>
